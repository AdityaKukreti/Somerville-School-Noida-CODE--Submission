        ...
        if value == True:
            ...
            def del_confirm():
                if password == confirm_entry.get():
                    ...
                    account_deletion_mail(first_name_account_entry.get(),email_account_entry.get())
                else:
    ...
    def email_change():
        ...
        def check_email():
            ...
            if change_email_entry.get() == change_email_reentry.get():
                ...
                if email_change_alert_email(first_name_account_entry.get(),email_account_entry.get(),code) == True:
